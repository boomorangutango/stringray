...
class ConcreteBeam(object):
    ...
    def new_xsect_shape(self, verts=None, b=12.0, h=24.0, bf=0.0, hf=0.0, cover=1.5):
        self.xsect = XsectShape(self, verts=verts, b=b, h=h, hf=hf, bf=bf, cover=cover)
        return self.xsect
    ...
    def calc_axial(self, c):
        ...
        self.conc_stress_region = self.get_whitney_block(self.conc_verts_rc, c)
        ...
        for bar in self.long_reinf:
            ...
            bar.strain = -self.material.strain_ult*(bar.y_rc/c - 1)
    ...
    def plot_strain(self):
        ...
        # Plot strain curve.
        strain_fig.add_trace(go.Scatter(x=[self.material.strain_ult, -self.material.strain_ult*(self.xsect.max_y/self.c - 1)],
