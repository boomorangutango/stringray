...
class AppLayout(object):
    ...
    def __init__(self, input_box, plot_box, output_box):
        ...
        self.main_view.children = [self.calc_layout, self.help_box, self.file_box]
...
class StackedLayout(object):
    ...
    def __init__(self, input_box, plot_box, output_box):
        ...
        # Stacked layout for overall app.
        self.main_view = wg.VBox([input_accordion, plot_accordion, output_accordion])
