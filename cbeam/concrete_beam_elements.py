...
class ConcMaterial(object):
    ...
    def calc_beta1(self, fc_prime):
        ...
        return beta1
    def run_calc(self, fc_prime, strain_ult, Ec):
        self.fc_prime = fc_prime
        self.strain_ult = strain_ult
        self.Ec = Ec
...
class LongReinf(object):
    def __init__(self, parent, size='9', qty=1.0, x=0.0, y=0.0, fy=60000.0, Es=29000000.0):
        self.parent = parent
        self.size = size
        self.qty = qty
    ...
    def run_calc(self, size, qty, x, y, fy, Es):
        self.size = size
        self.qty = qty
        self.x = x
        self.y = y
