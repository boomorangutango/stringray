...
class ConcreteBeam(object):
    ...
    def plot_px(self):
        ...
        fig1 = px.line(x=shape_verts[:,0], y=shape_verts[:,1], 
                       title='Section', width=500, height=500)
        # fig1.update_xaxes(range=[self.xsect.min_x-5, self.xsect.max_x+5], constrain='domain')
