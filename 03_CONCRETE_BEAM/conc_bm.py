...
if __name__ == "__main__":
    beam = ConcreteBeam()
    beam.new_long_reinf(size='10', qty=3.0, y=22.635)
    # beam.new_long_reinf(size='6', qty=2.0, y=1.875)
    beam.new_xsect_shape(b=12.0, h=24.0, bf=0.0, hf=0.0)
    # beam.new_xsect(verts=[[3,0],
    #                       [9,0],
    #                       [12, 24],
    #                       [0, 24]])
    beam.new_material()
